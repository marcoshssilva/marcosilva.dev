...
import { Alert, Box, Button, Card, Container, TextField, ThemeProvider, Typography, createTheme } from "@mui/material";
...
export default function SectionContactMe() {
  ...
  return (
    <Box component={'section'} id="section-contact-me" className={'relative box-section background-contact-me'}>
      <Container className={'min-h-screen py-[97px] px-4'}>
        <Typography
        ...
        <Box className={'grid grid-cols-2 gap-2 mb-6 items-stretch'}>

          <Box className={'col-span-1 flex h-full'}>
          ...
          <form noValidate className="col-span-1 m-0 w-full py-6" autoComplete="off" onSubmit={onSubmitContactMe}>
